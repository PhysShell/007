...
consumed without independent verification (admission table over the epistemic
statuses in `docs/decision-and-admission-protocol.md`, not a verdict on the
tool): `docs/gortex-evaluation-harness.md`.
