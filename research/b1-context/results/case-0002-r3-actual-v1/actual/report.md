...
| field | value |
|---|---|
| deterministic_compilation_pipeline | **PARTIAL** |
...
- Both extractors ran deterministically over the local CAS and produced 303 derived transcript records (1101185 bytes), user-visible only, no chain-of-thought.
