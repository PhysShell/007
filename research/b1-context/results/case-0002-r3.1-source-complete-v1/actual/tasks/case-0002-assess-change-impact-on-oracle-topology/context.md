...
**Task:** Assess change impact on the oracle topology: which decisions, work items, evidence and checks depend on the chosen constraint, and what must be re-reviewed if it changes.

**Task id:** case-0002-assess-change-impact-on-oracle-topology
...
- obs-authority-model: not relevant to this task: topics authority-model share nothing with required oracle-topology or preferred measurement,r21-evidence
- obs-lock-supersession-chain: not relevant to this task: topics supersession share nothing with required oracle-topology or preferred measurement,r21-evidence
- obs-metadata-head: not relevant to this task: topics round-0 share nothing with required oracle-topology or preferred measurement,r21-evidence
- obs-next-permitted-step: not relevant to this task: topics product-integration,round-0 share nothing with required oracle-topology or preferred measurement,r21-evidence
- obs-plane-record-frozen: not relevant to this task: topics product-integration,round-0 share nothing with required oracle-topology or preferred measurement,r21-evidence
- obs-plane-record-not-frozen-v6: not eligible: superseded_by obs-round0-closed
- obs-plane-reviewer: not relevant to this task: topics source-planes share nothing with required oracle-topology or preferred measurement,r21-evidence
- obs-profiler-prior-defect: not eligible: superseded_by obs-profiler-fail-closed
- obs-relay-rule: not relevant to this task: topics authority-model share nothing with required oracle-topology or preferred measurement,r21-evidence
- obs-reviewer-acceptance-claim: not eligible: authority agent_claim is never authoritative
- obs-reviewer-durability-resolved: not relevant to this task: topics durability,round-0 share nothing with required oracle-topology or preferred measurement,r21-evidence
- obs-reviewer-durability-unresolved-v6: not eligible: superseded_by obs-reviewer-durability-resolved
- obs-round0-closed: not relevant to this task: topics product-integration,round-0 share nothing with required oracle-topology or preferred measurement,r21-evidence
- obs-source-data-origin: not relevant to this task: topics source-planes share nothing with required oracle-topology or preferred measurement,r21-evidence
